...
from framework_conventions import RoleEntry, build_bank, build_convention
...
def test_rgb_only_board_advertises_rgb_led():
    # No plain `led` present -> the decorated group is the bank.
