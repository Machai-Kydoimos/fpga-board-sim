...
| `preview.board.led[i]` | widget | `fpga_sim/ui/board_display.py:1047` |
| `preview.board.leds.ledr` | zone | `fpga_sim/ui/board_display.py:1061` |
| `preview.board.seg[i]` | widget | `fpga_sim/ui/board_display.py:1053` |
| `preview.board.sw[i]` | widget | `fpga_sim/ui/board_display.py:1049` |
| `preview.footer.load-vhdl` | item | `fpga_sim/ui/board_display.py:1312` |
| `preview.footer.select-board` | item | `fpga_sim/ui/board_display.py:1299` |
...
| `sim.board.chip` | widget | `fpga_sim/ui/board_display.py:1045` |
| `sim.board.led[i]` | widget | `fpga_sim/ui/board_display.py:1047` |
