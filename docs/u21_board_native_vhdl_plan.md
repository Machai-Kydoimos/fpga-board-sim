...
**Status:** IN PROGRESS — A0 merged (PR #209), A1 merged (PR #210), A2 merged (PR #211), A3 in review. Update the [status ledger](#status-ledger) as phases land.
...
| A3 | Generator + overlay | — | in review |
